...
import netzbegruenung.keycloak.authenticator.ScaSelectionAuthenticator;
...
public class KeycloakOtpConditionalAuthenticator implements ConditionalAuthenticator {
  ...
  public boolean matchCondition(AuthenticationFlowContext context) {
    ...
    if (chosenScaMethod != null && chosenScaMethod.equals("keycloak_authenticator")) {  // replace "expected-sca-method" with the actual method this authenticator handles
